...
public class AttackDuck {
    ...
    public static void attackStrategy(RobotController rc) throws GameActionException {
        ...
        for (RobotInfo enemy : enemyRobots) {
            ...
            if (enemy.hasFlag() || rng.nextBoolean()){
                stepped = march2Target(rc, enemy.getLocation());
        ...
        if (flagLocs.size() == 0) {
            ...
            if (flagLocs.size() != 0 && rng.nextInt(5) != 0){
                ...
                stepped = march2Target(rc, closestFlag);
    ...
    private static Direction scoutRandom(RobotController rc) throws GameActionException {
        ...
        return march2Target(rc, randTarget);
    }

    

    // private static int closestSpawnLoc(RobotController rc) throws GameActionException {
    ...
    //         if (robotLoc.distanceSquaredTo(spawnLoc) < minSpawnDst){
    //             idx = i;
    //             minSpawnDst = robotLoc.distanceSquaredTo(spawnLoc);
    //         }
    //     }
    //     return idx;
    // }
