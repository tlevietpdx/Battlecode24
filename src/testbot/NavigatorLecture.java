...
public class NavigatorLecture {
    ...
    public static void move2Target(RobotController rc, MapLocation loc, boolean fill) throws GameActionException {
        ...
        if(rc.canMove(dir)) rc.move(dir);
            ...
            Direction randDir = RobotPlayer.directions[rng.nextInt(8)];
    ...
    public static void explore(RobotController rc) throws GameActionException {
        if(rc.isMovementReady()) {
            ...
            if(crumbLocs.length > 0) {
                move2Target(rc, crumbLocs[0], false);
            }

            if(dir == null || !rc.canMove(dir)) {
                dir = RobotPlayer.directions[rng.nextInt(8)];
            }
            if(rc.canMove(dir)) rc.move(dir);
        }
    }
