...
public class NavigatorTest {
    ...
    // @Test
    // public void testGetPrioritizedDirection() {
    //     // Test for a specific forward direction (e.g., NORTH)
    //     ArrayList<Direction> directions = Navigator.getPrioritizedDirection(rc, Direction.NORTH);

    //     // Check that all directions are valid and include expected ones
    //     HashSet<Direction> expectedDirections = new HashSet<>(Arrays.asList(
    //         Direction.NORTH, Direction.NORTHEAST, Direction.NORTHWEST, Direction.EAST, Direction.WEST
    //     ));

    //     assertTrue(directions.containsAll(expectedDirections));
    //     assertEquals(5, directions.size());  // Should have exactly 5 directions
    // }
